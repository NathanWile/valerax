...
if(!['805407674450575360'].some(role => message.member.roles.cache.get(role)) && !message.member.hasPermission('ADMINISTRATOR')) 
...
const tag = '⚚'   
const kadınrol = message.guild.roles.cache.find(r => r.id === '805407684051730443') 
const kadınrol2 = message.guild.roles.cache.find(r => r.id === '805407685201494171')
const kayıtsız = message.guild.roles.cache.find(r => r.id === '805407709608280074')
const genelchat = message.guild.channels.cache.find(c => c.id === '806604900736958487')
const savelog = message.guild.channels.cache.find(c => c.id === '805407784123236394')
